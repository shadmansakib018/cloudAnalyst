...
public class CloudSim extends GridSimCore {
	 ...
	 * @post $none
	 */
	protected void send(int destID, double delay, int gridSimTag, Object data, double dataSize) {
...
//            delay = 700;
//        } else if (dataSize < 1100) {
//            delay = 1200;
//        }
//        else if (dataSize < 1600) {
//            delay = 2000;
//        }else {
//        	delay = 4000;
//        }
//		System.out.println("data size: " + dataSize +" delay: " + delay);
