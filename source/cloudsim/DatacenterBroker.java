...
//	            + Thread.currentThread().getId()); 
	...
	public void submitVMList(VirtualMachineList list){
		System.out.println("*******DCB line 90: submitting vms*****");
     ...
     */
	public void body(){
		System.out.println("*************in body of DCB*****************");
...
//				System.out.println("VMID: "+characteristics.vmId + " CPUS: " + characteristics.cpus + " memory: " + characteristics.memory);
			}
		}
     ...
     * @pre $none
     * @post $none
     * this function is not called. these submit cloudlets are handled in datacenter controller file
     */
